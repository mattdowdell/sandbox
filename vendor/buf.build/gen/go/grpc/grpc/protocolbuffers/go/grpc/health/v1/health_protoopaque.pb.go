...
type HealthCheckResponse struct {
	state             protoimpl.MessageState            `protogen:"opaque.v1"`
	xxx_hidden_Status HealthCheckResponse_ServingStatus `protobuf:"varint,1,opt,name=status,proto3,enum=grpc.health.v1.HealthCheckResponse_ServingStatus"`
	unknownFields     protoimpl.UnknownFields
	sizeCache         protoimpl.SizeCache
}
...
type HealthListRequest_builder struct {
	_ [0]func() // Prevents comparability and use of unkeyed literals for the builder.

}

func (b0 HealthListRequest_builder) Build() *HealthListRequest {
	m0 := &HealthListRequest{}
	b, x := &b0, m0
	_, _ = b, x
	return m0
}
...
type HealthListResponse struct {
	state               protoimpl.MessageState          `protogen:"opaque.v1"`
	xxx_hidden_Statuses map[string]*HealthCheckResponse `protobuf:"bytes,1,rep,name=statuses,proto3" protobuf_key:"bytes,1,opt,name=key" protobuf_val:"bytes,2,opt,name=value"`
	unknownFields       protoimpl.UnknownFields
	sizeCache           protoimpl.SizeCache
}
...
func (x *HealthListResponse) SetStatuses(v map[string]*HealthCheckResponse) {
	x.xxx_hidden_Statuses = v
}

type HealthListResponse_builder struct {
	_ [0]func() // Prevents comparability and use of unkeyed literals for the builder.

	// statuses contains all the services and their respective status.
	Statuses map[string]*HealthCheckResponse
}

func (b0 HealthListResponse_builder) Build() *HealthListResponse {
	m0 := &HealthListResponse{}
	b, x := &b0, m0
	_, _ = b, x
...
const file_grpc_health_v1_health_proto_rawDesc = "" +
	...
	"\x05Watch\x12\".grpc.health.v1.HealthCheckRequest\x1a#.grpc.health.v1.HealthCheckResponse0\x01B\x89\x01\n" +
	"\x11io.grpc.health.v1B\vHealthProtoP\x01ZEbuf.build/gen/go/grpc/grpc/protocolbuffers/go/grpc/health/v1;healthv1\xa2\x02\fGrpcHealthV1\xaa\x02\x0eGrpc.Health.V1b\x06proto3"
