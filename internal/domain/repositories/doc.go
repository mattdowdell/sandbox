...
// repisitory should be concerned with the business process rather than the application.
//
// For example, a repository may have a method for updating a specific column in a database row,
// despite multiple columns theoretically supporting updates.
//
// # Deviations
//
