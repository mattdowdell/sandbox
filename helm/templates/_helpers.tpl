...
{{- if .name -}}
{{- $name := include "helpers.name" .context }}
...
Common labels
*/}}
{{- define "example-rpc.labels" -}}
helm.sh/chart: {{ include "example-rpc.chart" . }}
{{ include "example-rpc.selectorLabels" . }}
{{- if .Chart.AppVersion }}
app.kubernetes.io/version: {{ .Chart.AppVersion | quote }}
{{- end }}
app.kubernetes.io/managed-by: {{ .Release.Service }}
