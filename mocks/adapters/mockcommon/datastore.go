...
func (_m *Datastore) UpdateResource(_a0 context.Context, _a1 *entities.Resource) (*entities.Resource, error) {
	ret := _m.Called(_a0, _a1)
...
func (_c *Datastore_UpdateResource_Call) Return(_a0 *entities.Resource, _a1 error) *Datastore_UpdateResource_Call {
	_c.Call.Return(_a0, _a1)
	return _c
}

func (_c *Datastore_UpdateResource_Call) RunAndReturn(run func(context.Context, *entities.Resource) (*entities.Resource, error)) *Datastore_UpdateResource_Call {
	_c.Call.Return(run)
	return _c
}
