...
func (_m *AuditEventFacade) List(_a0 context.Context, _a1 *slog.Logger) ([]*entities.AuditEvent, error) {
	...
	var r1 error
	if rf, ok := ret.Get(0).(func(context.Context, *slog.Logger) ([]*entities.AuditEvent, error)); ok {
		return rf(_a0, _a1)
	}
	if rf, ok := ret.Get(0).(func(context.Context, *slog.Logger) []*entities.AuditEvent); ok {
		r0 = rf(_a0, _a1)
	} else {
		if ret.Get(0) != nil {
...
//   - _a0 context.Context
//   - _a1 *slog.Logger
func (_e *AuditEventFacade_Expecter) List(_a0 interface{}, _a1 interface{}) *AuditEventFacade_List_Call {
	return &AuditEventFacade_List_Call{Call: _e.mock.On("List", _a0, _a1)}
}

func (_c *AuditEventFacade_List_Call) Run(run func(_a0 context.Context, _a1 *slog.Logger)) *AuditEventFacade_List_Call {
...
func (_c *AuditEventFacade_List_Call) RunAndReturn(run func(context.Context, *slog.Logger) ([]*entities.AuditEvent, error)) *AuditEventFacade_List_Call {
	_c.Call.Return(run)
	return _c
}

// Watch provides a mock function with given fields: _a0, _a1
func (_m *AuditEventFacade) Watch(_a0 context.Context, _a1 *slog.Logger) <-chan *entities.AuditEvent {
	ret := _m.Called(_a0, _a1)
	...
	if rf, ok := ret.Get(0).(func(context.Context, *slog.Logger) <-chan *entities.AuditEvent); ok {
		r0 = rf(_a0, _a1)
	} else {
		if ret.Get(0) != nil {
...
//   - _a0 context.Context
//   - _a1 *slog.Logger
func (_e *AuditEventFacade_Expecter) Watch(_a0 interface{}, _a1 interface{}) *AuditEventFacade_Watch_Call {
	return &AuditEventFacade_Watch_Call{Call: _e.mock.On("Watch", _a0, _a1)}
}

func (_c *AuditEventFacade_Watch_Call) Run(run func(_a0 context.Context, _a1 *slog.Logger)) *AuditEventFacade_Watch_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run(args[0].(context.Context), args[1].(*slog.Logger))
	})
	return _c
...
func (_c *AuditEventFacade_Watch_Call) RunAndReturn(run func(context.Context, *slog.Logger) <-chan *entities.AuditEvent) *AuditEventFacade_Watch_Call {
	_c.Call.Return(run)
	return _c
}
