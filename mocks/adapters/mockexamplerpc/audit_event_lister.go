...
func (_m *AuditEventLister) Execute(_a0 context.Context, _a1 repositories.AuditEvent) ([]*entities.AuditEvent, error) {
	...
	var r1 error
	if rf, ok := ret.Get(0).(func(context.Context, repositories.AuditEvent) ([]*entities.AuditEvent, error)); ok {
		return rf(_a0, _a1)
	}
	if rf, ok := ret.Get(0).(func(context.Context, repositories.AuditEvent) []*entities.AuditEvent); ok {
		r0 = rf(_a0, _a1)
	} else {
		if ret.Get(0) != nil {
	...
	if rf, ok := ret.Get(1).(func(context.Context, repositories.AuditEvent) error); ok {
		r1 = rf(_a0, _a1)
	} else {
		r1 = ret.Error(1)
	}
...
func (_e *AuditEventLister_Expecter) Execute(_a0 interface{}, _a1 interface{}) *AuditEventLister_Execute_Call {
	return &AuditEventLister_Execute_Call{Call: _e.mock.On("Execute", _a0, _a1)}
}

func (_c *AuditEventLister_Execute_Call) Run(run func(_a0 context.Context, _a1 repositories.AuditEvent)) *AuditEventLister_Execute_Call {
...
func (_c *AuditEventLister_Execute_Call) RunAndReturn(run func(context.Context, repositories.AuditEvent) ([]*entities.AuditEvent, error)) *AuditEventLister_Execute_Call {
	_c.Call.Return(run)
	return _c
}
