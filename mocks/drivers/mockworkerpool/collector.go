...
func (_m *Collector[U]) Collect(_a0 workerpool.Result[U]) {
	_m.Called(_a0)
}
...
func (_c *Collector_Collect_Call[U]) Run(run func(_a0 workerpool.Result[U])) *Collector_Collect_Call[U] {
	_c.Call.Run(func(args mock.Arguments) {
		run(args[0].(workerpool.Result[U]))
	})
	return _c
}
...
func (_c *Collector_Collect_Call[U]) RunAndReturn(run func(workerpool.Result[U])) *Collector_Collect_Call[U] {
	_c.Run(run)
	return _c
}
